...
RELEASE_V2 = ROOT / "fixtures/usability/UX-K-20260724.release.v1.yaml"
...
def test_v2_release_pins_product_and_reviewer_material() -> None:
    ...
    assert release.release_id == "LOCAL-UX-RELEASE-1-5227D18"
    assert release.product_revision == "5227d18ae9ea7ed8d94dd00a8ffb57570b5dd511"
